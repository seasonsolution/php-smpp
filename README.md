...
PHPSMPP is available on [Packagist](https://packagist.org/packages/seasonsolution/php-smpp) (using semantic versioning), and installation via [Composer](https://getcomposer.org) is the recommended way to install PHPSMPP. Just add this line to your `composer.json` file:

```json
"seasonsolution/php-smpp": "*.*"
```

or run

```sh
composer require seasonsolution/php-smpp
```
...
## Contributing
Please submit bug reports, suggestions and pull requests to the [GitHub issue tracker](https://github.com/seasonsolution/php-smpp/issues).
...
```sh
git remote set-url upstream https://github.com/seasonsolution/php-smpp.git
```